...
keymap.set("n", "<leader>E", ":NvimTreeFocus<CR>") -- toggle focus to file explorer keymap.set("n", "<leader>ef", ":NvimTreeFindFile<CR>") -- find file in file explorer
keymap.set("n", "<leader>ef", ":NvimTreeFindFile<CR>") -- find file in file e eplorer
-- Telescope
...
--    "sh",
--    "-c",
--    "mvn spring-boot:run; echo 'Spring Boot stopped. Press any key to close...'; read"
--  }, { detach = true })
--end, { desc = "Run Spring Boot app in Alacritty" })
--
--
...
--    "sh",
--    "-c",
--    string.format("java %s; echo 'Press any key to exit...'; read", vim.fn.shellescape(file)),
--  }, { detach = true })
--end, { desc = "Run Java file in Alacritty" })
--keymap.set("n", "<leader>jR", function()
--  -- Tries to close the terminal buffer
--  for _, bufnr in ipairs(vim.api.nvim_list_bufs()) do
--    if vim.bo[bufnr].buftype == "terminal" then
--      vim.api.nvim_buf_delete(bufnr, { force = true })
--      print("Closed terminal buffer running Spring Boot.")
--      return
--    end
--  end
--  print("No Spring Boot terminal buffer found.")
--end, { desc = "Stop Spring Boot app" })
